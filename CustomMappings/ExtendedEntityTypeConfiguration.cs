using EntityFrameworkCore.GraphManager.CustomMappings.MappingHelpers;
...
namespace EntityFrameworkCore.GraphManager.CustomMappings
{
    /// <summary>
    ...
    public class ExtendedEntityTypeConfiguration<TEntity>
        : IEntityTypeConfiguration<TEntity>, IExtendedEntityTypeConfiguration<TEntity>
        where TEntity : class
    {
        /// <summary>
